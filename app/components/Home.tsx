...
const Home = () => {
  return (
    ...
    padding'>
      ...
      my 8:00 PM staple has become creating interactive web canvases <span className="font-medium">inspired by the little things around me.</span>
      <br /> <br />
      I&apos;m <span className="font-medium">experienced in backend architecture and database management</span> but have a soft spot for minimalist, 
